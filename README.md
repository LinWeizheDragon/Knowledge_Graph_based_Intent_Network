...
- multiGPU
```
python main.py --dataset amazon-book --dim 64 --lr 0.0008 --sim_regularity 0.00001 --batch_size 8192 --node_dropout True --node_dropout_rate 0.5 --mess_dropout True --mess_dropout_rate 0.1 --gpu_id 0 --context_hops 3 --save True | tee training_log/batch1024x8_new_log.log
```
